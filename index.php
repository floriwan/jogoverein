...
<html>
    ...
    <head>
        ...
        <meta name="keywords" lang="de" content="JoGoVEREIN, Access, MySQL, SEPA, Vereinsverwaltung, Vereinsprogramm, Vereinssoftware, Datenbank, Lastschriftverfahren, Mitgliederverwaltung, Kassenbuch, Kassenführung"/>
        <meta name="description" lang="de" content="JoGoVEREIN das flexible Datenbankprogramm für Vereinsarbeit im Microsoft-Access und MySQL-Format."/>
                
        <meta name="robots" content="all"/>
        <meta name="author" content="Joachim Göldenitz"/>
    </head>
    ...
    <body class="landing">
        ...
        <div id="page-wrapper">
                ...
                <section class="box special">
                    ...
                    <a class="img_link" href="http://www.heise.de/download/jogoverein-1141310.html" title="JoGoVEREIN" target="_blank"><img alt="Heise" src="http://www.heise.de/software/icons/download_logo2.png"></a>
                    <a class="img_link" href="http://www.computerbild.de/download/JoGoVerein-3895980.html" title="JoGoVEREIN" target="_blank"><img alt="ComputerBild" src="images/computerbild.bmp"></a>
                </section>
